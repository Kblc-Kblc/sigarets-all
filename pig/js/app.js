...
const slidersTwo = document.querySelectorAll('.range-slider-two');
const slidersThree = document.querySelectorAll('.range-slider-three');
  ...
  //   ... the input inside addEventListener() is looking for the input action, we could change it to something like change
    slider.querySelector('input').addEventListener('input', (event)=>{
      ...
      slider.querySelector('span').innerHTML = event.target.value + ' <small>сигарет</small>';
  ...
  Array.prototype.forEach.call(slidersTwo,(slider)=>{
    // Look inside our slider for our input add an event listener
  //   ... the input inside addEventListener() is looking for the input action, we could change it to something like change
    slider.querySelector('input').addEventListener('input', (event)=>{
      // 1. apply our value to the span
      slider.querySelector('span').innerHTML = event.target.value + ' <small>руб</small>';
      // 2. apply our fill to the input
      applyFill(event.target);
    });
    // Don't wait for the listener, apply it now!
  ...
  Array.prototype.forEach.call(slidersThree,(slider)=>{
    // Look inside our slider for our input add an event listener
  //   ... the input inside addEventListener() is looking for the input action, we could change it to something like change
    slider.querySelector('input').addEventListener('input', (event)=>{
      // 1. apply our value to the span
